...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <input type="text" name="nama_penerbit" id="" class="form form-control" value="{{$datapenerbit->nama_penerbit}}">
            @error('nama_penerbit')
                <small>{{$message}}</small>
            @enderror
            <span>Keterangan</span>
            <input type="text" name="keterangan" id="" class="form form-control" value="{{$datapenerbit->keterangan}}">
            @error('keterangan')
                <small>{{$message}}</small>
            @enderror
